...
#else
		SetDlgItemText(hDlg, IDC_LABEL_UP, (LPSTR)INPUTCONFIG_LABEL_UP);
		SetDlgItemText(hDlg, IDC_LABEL_DOWN, (LPSTR)INPUTCONFIG_LABEL_DOWN);
		SetDlgItemText(hDlg, IDC_LABEL_LEFT, (LPSTR)INPUTCONFIG_LABEL_LEFT);
		SetDlgItemText(hDlg, IDC_LABEL_A, (LPSTR)INPUTCONFIG_LABEL_A);
		SetDlgItemText(hDlg, IDC_LABEL_B, (LPSTR)INPUTCONFIG_LABEL_B);
		SetDlgItemText(hDlg, IDC_LABEL_X, (LPSTR)INPUTCONFIG_LABEL_X);
		SetDlgItemText(hDlg, IDC_LABEL_Y, (LPSTR)INPUTCONFIG_LABEL_Y);
		SetDlgItemText(hDlg, IDC_LABEL_L, (LPSTR)INPUTCONFIG_LABEL_L);
		SetDlgItemText(hDlg, IDC_LABEL_R, (LPSTR)INPUTCONFIG_LABEL_R);
		SetDlgItemText(hDlg, IDC_LABEL_START, (LPSTR)INPUTCONFIG_LABEL_START);
		SetDlgItemText(hDlg, IDC_LABEL_SELECT, (LPSTR)INPUTCONFIG_LABEL_SELECT);
		SetDlgItemText(hDlg, IDC_LABEL_UPRIGHT, (LPSTR)INPUTCONFIG_LABEL_UPRIGHT);
		SetDlgItemText(hDlg, IDC_LABEL_UPLEFT, (LPSTR)INPUTCONFIG_LABEL_UPLEFT);
		SetDlgItemText(hDlg, IDC_LABEL_DOWNRIGHT, (LPSTR)INPUTCONFIG_LABEL_DOWNRIGHT);
		SetDlgItemText(hDlg, IDC_LABEL_DOWNLEFT, (LPSTR)INPUTCONFIG_LABEL_DOWNLEFT);
		SetDlgItemText(hDlg, IDC_LABEL_BLUE, (LPSTR)INPUTCONFIG_LABEL_BLUE);
#endif
...
switch(msg)
	...
	case WM_INITDIALOG:
		...
		// Support Unicode display
#ifdef HOST_32
		SetDlgItemText(hDlg,IDC_LABEL_BLUE,(LPSTR)HOTKEYS_LABEL_BLUE);
#else
